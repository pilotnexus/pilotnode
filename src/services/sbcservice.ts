...
import { CommandService } from "../connectors/local/commandservice.js";
import { FileService } from "../connectors/local/fileservice.js";
import { ValueService } from "./valueservice.js";
import { ValueType, ValueGroup, SubValue, ConnectorConfig, ValueProperties, DataType } from "../value.js";
import { FileValueConfig } from "../connectors/local/filevalueconfig.js";
import { CommandValueConfig } from "../connectors/local/commandvalueconfig.js";
import { LocalConfig } from "../connectors/local/localconfig.js";
...
export class SbcService {
    ...
    async is_raspberry(): Promise<boolean> {
        try {
            ...
            let cpuinfo = await fs.readFile("/proc/cpuinfo", "utf8");
